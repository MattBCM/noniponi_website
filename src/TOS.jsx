  ...
  return (
    <div className="container-fluid mt-2 bg-light min-vh-100 p-5">
      ...
      <div className="container-fluid w-100 tos-container pt-4">
        ...
        <p className="fs-5">
          🌿Artistree Form🌿 <br />
          By reading this document you have promised to have read, looked over,
          acknowledged, and accepted all terms and conditions, information, and
          prices shown as stated by the document.
        </p>
        <p>
        ...
        <br />
        <p className="fs-5">
          <strong>✒️Secret Menu: </strong>
          <span className="fw-bold text-danger-emphasis bg-danger-subtle">
            If you would like the lineart to be done with a dip pen
          </span>
          &nbsp;(anime/manga pen and ink): Due to preparation, use of materials,
          maintenance, and extra time&nbsp;
          <span className="fw-bold text-danger-emphasis bg-danger-subtle">
            the whole order would cost an additional $25
          </span>
          . <br />
          Sketches would be done in pencil for this type of order and the
          lineart would be scanned to edit digitally.
        </p>
        <p>
            ...
            <thead>
              <tr>
                <th className="bg-success-subtle">
                  I{" "}
                  <strong style={{ textDecoration: "underline" }}>WILL</strong>
                  &nbsp;Do
                </th>
              ...
              <tr>
                <td>
                  <ul className="list-group list-group-flush">
                    ...
                    <li className="list-group-item">✅Anime Girls</li>
                ...
                <td>
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">🔸Furry</li>
                    <li className="list-group-item">🔸Custom Creatures</li>
                    <li className="list-group-item">🔸Some Animals</li>
                    <li className="list-group-item">🔸Anime Boys</li>
                  </ul>
                </td>
                <td>
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">❌Gore</li>
                    <li className="list-group-item">❌Mecha</li>
                    <li className="list-group-item">❌Real People</li>
                    <li className="list-group-item">❌NSFW</li>
                    <li className="list-group-item">
        ...
        <p className="fs-5">
          *Items under{" "}
          <span className="bg-warning-subtle fw-bold">“I CAN TRY”</span> may not
          be as high of a quality compared to the rest of my work*
        </p>
        <p className="text-danger fs-5">
          **I will immediately deny commissions for NFT/Crypto/AI Works**
        </p>
        <p className="text-danger fw-bold fs-5">
          **I do not offer my art for commercial use**
        </p>
        <h2>COMMISSIONER AND ARTIST RIGHTS</h2>
        <p>
          Commissioners will be given a drawing that has a plain/colored
          background, a version that says “thank you” on it, and a transparency
          background (and a simple background if that was requested in the
          form).
        </p>
        <div className="container-fluid text-start w-75">
          ...
          <ul style={{ listStyleType: "none" }}>
            ...
            <li>
              ✅Post your commission on my social media with my @ on the drawing
            </li>
          ...
          <ul style={{ listStyleType: "none" }}>
            <li>
              ❌Use your commission{" "}
              <span style={{ textDecoration: "underline" }}>COMMERCIALLY</span>
            </li>
            <li>
              ❌Repost your commission on your social media without crediting me
              as the artist
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              This is another reminder that items under{" "}
              <span className="fw-bold bg-warning-subtle">“I CAN TRY”</span> may
              not look as good as the rest of my other works.
            </li>
            <li>
              If I post your commission to my social media and you would like to
              not be credited or tagged as the commissioner please let me know
            </li>
          </ul>
        </div>
        <h2>Examples</h2>
